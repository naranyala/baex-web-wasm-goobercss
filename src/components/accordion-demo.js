  ...
  render() {
    ...
    this.shadowRoot.querySelectorAll('.panel-header').forEach(header => {
      header.addEventListener('click', () => {
        ...
        this.shadowRoot.querySelectorAll('.panel-body').forEach(b => b.classList.remove('open'));
        this.shadowRoot.querySelectorAll('.panel-header').forEach(h => h.classList.remove('open'));
